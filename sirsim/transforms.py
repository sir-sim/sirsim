...
import sirsim
from sirsim.base import FrozenObject
from sirsim.dists import Distribution, DistOrArrayParam
from sirsim.exceptions import ValidationError
from sirsim.params import ShapeParam, IntParam, EnumParam, BoolParam
...
class Convolution(Transform):
    ...
    Notes
    -----
    As is typical in agent networks, this is technically correlation rather
