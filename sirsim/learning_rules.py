...
from sirsim.params import (Default, IntParam, FrozenObject, NumberParam,
                          Parameter, Unconfigurable)
from sirsim.synapses import Lowpass, SynapseParam
from sirsim.utils.compat import is_iterable, is_string, itervalues
...
def _deprecated_tau(old_attr, new_attr):
    ...
    def set_tau(self, val):
        ...
        since = "v2.8.0"
        url = "https://github.com/sirsim/sirsim/pull/1095"
