...
def log(level='warning', path=None):
    ...
    Typically someone using Sirsim as a library will set up their own
    logging things, and Sirsim will just populate their log.
    However, if the user is using Sirsim directly, they can use this
